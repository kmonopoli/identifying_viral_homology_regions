...
#                 print(data[i:i+7])
    ...
    i = start
    while i<stop:
        sum(data[i:i+seq_len]) # sum homology for that region
        index_ls.append(posn_nums[i])#+start])
        i+=1
